...
function Intro() {
  ...
  return (
    <div className="flex flex-col justify-center items-center ">
      <div className="mt-20 relative">
        ...
        <div className="min-w-[320px] min-h-[420px]  flex justify-center items-center">
          <Image
            ...
            alt="testBg"
            fill
            className="border-[3px] border-blossom-darkGray border-solid rounded-xl"
          />
        </div>
        <Image
          src={TestLogo}
          alt="testLogo"
          className="absolute left-1/2 top-1/2 translate-y-[-50%] translate-x-[-50%] animate-fade-in"
          width={300}
          height={0}
        />
      ...
      <button
        className="w-80 h-12 bg-blossom-green border-[3px] border-blossom-white border-solid rounded-xl  mt-4 "
        onClick={movePage}
      >
        초대장 만들러 가기
      </button>
